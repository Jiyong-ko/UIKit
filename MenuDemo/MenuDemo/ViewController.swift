...
class ViewController: UIViewController {
    ...
    func showMenu() {
        ...
        alert.addAction(UIAlertAction(title: "Open", style: .default) { [weak self] _ in self?.showMessage("Open 선택됨")
        })

        alert.addAction(UIAlertAction(title: "Find", style: .default) { [weak self] _ in self?.showMessage("Find 선택됨")
        })
